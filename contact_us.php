...
$content= $_POST['content'];
  $mySql = "SELECT * FROM halaman WHERE kd_halaman='CONTACTUS' ";
...
if (isset($_POST['buttonsubmit'])) {
  ...
  $pesanError= array();
  if (trim($kd_halaman)=="") {
    $pesanError[]="Kode Data <b>Contact Us</b> Masih kosong !!";
  }
  if (trim($content)=="") {
    $pesanError[]="Data Content<b>Contact Us</b> Masih kosong !!";
  }
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form id="formcontactus" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <input type="hidden" name="kd_halaman" value="CONTACTUS">
...
<script type="text/javascript">
 ...
 var formcontactus = $("#formcontactus").serialize();
 var validator = $("#formcontactus").bootstrapValidator({
  framework: 'bootstrap',
  feedbackIcons: {
  ...
  fields : {
    content : {
     validators: {
      notEmpty: {
       message: 'Content Contact Us Harus  Diisi'
     }
   }
 }, 
