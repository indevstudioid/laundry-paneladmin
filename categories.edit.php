...
$kd_categories  = isset($_GET['id']) ?  $_GET['id'] : $_POST['kd_categories'];
$mySql = "SELECT * FROM categories WHERE kd_categories='$kd_categories'";
$myQry = mysql_query($mySql);
$myData= mysql_fetch_array($myQry);

  // Masukkan data ke variabel, untuk dibaca di form input
$kd_categories   = $myData['kd_categories'];
$data_nama_categories = isset($_POST['nama_categories']) ?  $_POST['nama_categories'] : $myData['nama_categories'];
  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Data <small>Kategori</small></h2>
...
//    trim, htmlspecialchars dan stripslashes
  ...
  $nama_file  = str_replace(" ","_",$nama_categories); // Membuang karakter petik (')
$description=$_POST['description'];
 ...
 if (trim($description)=="") {
  ...
  if (empty($nama_foto)){
        $queryjeng = mysql_query("UPDATE categories SET  description='$description', nama_categories='$nama_categories', nama_file='$nama_file' WHERE kd_categories='$_GET[id]'") or die(mysql_error());
  ...
  if (count($pesanError)>=1) {
    ...
    $querytambahcategories = mysql_query("UPDATE categories SET  description='$description', nama_categories='$nama_categories', nama_file='$nama_file', foto='$jeneng' WHERE kd_categories='$_GET[id]'") or die(mysql_error());
}
             if ($querytambahcategories){
              unlink("../assets/admin/paneladmin/images/$myData[foto]");
             header('location: ./categories');
              }
...
?>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="col-lg-8">
          <div class="fileupload fileupload-new" data-provides="fileupload">
            <?php if (!empty($myData['foto'])) { ?>
              <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="../assets/admin/paneladmin/images/<?php echo $myData['foto']; ?>" alt=""></div>
        ...
        <div class="item form-group">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" id="nama_categories" name="nama_categories" value="<?php echo $kd_categories; ?>" readonly="readonly" class="form-control col-md-7 col-xs-12">
          </div>
        </div>
        <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="description" value="<?php echo $myData['description']; ?>" name="description" required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
