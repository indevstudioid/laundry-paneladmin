...
#                                               Name File     : cara_pembelian.tambah.php                                #
#                                               Release Date  :                                                     #
...
$content= $_POST['content'];
  $mySql = "SELECT * FROM halaman WHERE kd_halaman='PEMBELIAN' ";
...
$datacara_pembelian  = isset($_POST['nama_prov']) ? $_POST['nama_prov'] : '';
    ...
    <div class="page-title">
      <div class="title_left">
        <h3>
           Data Cara Pembelian
          <small>
            Manage Your Data Cara Pembelian
          </small>
        </h3>
      </div>
    </div>
...
if (isset($_POST['buttonsubmit'])) {
  ...
  $pesanError= array();
  if (trim($kd_halaman)=="") {
    $pesanError[]="Kode Data <b>cara Pembelian</b> Masih kosong !!";
  }
  if (trim($content)=="") {
    $pesanError[]="Data Content<b>cara Pembelian</b> Masih kosong !!";
  }
  ...
  #JIKA ADA PESAN ERROR DARI VALIDASI FORM 
   if (count($pesanError)>=1) {
    ...
    if ($edit){
      ...
      header('location: ./cara_pembelian');
    }
  }
}
?>
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form id="formpembelian" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <input type="hidden" name="kd_halaman" value="PEMBELIAN">
...
<script type="text/javascript">
 ...
 var formpembelian = $("#formpembelian").serialize();
 var validator = $("#formpembelian").bootstrapValidator({
  framework: 'bootstrap',
  feedbackIcons: {
