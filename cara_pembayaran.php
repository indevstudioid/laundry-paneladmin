...
#                                               Name File     : cara_pembayaran.tambah.php                                #
#                                               Release Date  :                                                     #
...
$content= $_POST['content'];
  $mySql = "SELECT * FROM halaman WHERE kd_halaman='PEMBAYARAN' ";
...
$datacara_pembayaran  = isset($_POST['nama_prov']) ? $_POST['nama_prov'] : '';
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>
          Tambah Data cara_pembayaran
          <small>
            Manage Your Data cara_pembayaran
          </small>
        </h3>
      </div>
    </div>
...
if (isset($_POST['buttonsubmit'])) {
  ...
  $pesanError= array();
  if (trim($kd_halaman)=="") {
    $pesanError[]="Kode Data <b>cara pembayaran</b> Masih kosong !!";
  }
  if (trim($content)=="") {
    $pesanError[]="Data Content<b>cara pembayaran</b> Masih kosong !!";
  }
  ...
  #JIKA ADA PESAN ERROR DARI VALIDASI FORM 
   if (count($pesanError)>=1) {
    ...
    if ($edit){
      ...
      header('location: ./cara_pembayaran');
    }
  }
}
?>
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form id="formpembayaran" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <input type="hidden" name="kd_halaman" value="PEMBAYARAN">

        <div class="form-group">
        
          <label>Content</label>
          <textarea class="form-control" name="content" id="content" rows="3"><?php echo $myData['content']; ?> </textarea>
        </div>
...
<script type="text/javascript">
 ...
 var formpembayaran = $("#formpembayaran").serialize();
 var validator = $("#formpembayaran").bootstrapValidator({
  framework: 'bootstrap',
  feedbackIcons: {
  ...
  fields : {
    content : {
     validators: {
      notEmpty: {
       message: 'Content Cara Pembayaran Harus  Diisi'
     }
   }
 }, 
