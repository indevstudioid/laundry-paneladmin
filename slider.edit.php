...
$kd_slider  = isset($_GET['id']) ?  $_GET['id'] : $_POST['kd_slider'];
$mySql = "SELECT * FROM slider WHERE kd_slider='$kd_slider'";
$myQry = mysql_query($mySql);
$myData= mysql_fetch_array($myQry);

  // Masukkan data ke variabel, untuk dibaca di form input
$kd_slider   = $myData['kd_slider'];
...
$data_deskribsi = isset($_POST['deskribsi']) ?  $_POST['deskribsi'] : $myData['deskribsi'];
      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Edit Data <small>slider</small></h2>
    ...
    # baca variabel 
      ...
      if (empty($nama_foto)){
        $queryjeng = mysql_query("UPDATE slider SET title='$title', deskribsi='$deskribsi' WHERE kd_slider='$kd_slider'") or die(mysql_error());
      ...
      if (count($pesanError)>=1) {
        ...
        <div class='alert alert-danger alert-dismissable'>
         ...
         if(($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/pjpeg")){
             ...
             $query = mysql_query("UPDATE slider SET title='$title', deskribsi='$deskribsi', foto='$jeneng'WHERE kd_slider='$kd_slider' ") or die(mysql_error());
                
                

              }
             if ($query){
              unlink("../assets/user/images/slider/$myData[foto]");
             header('location: ./slider');
              }
    ...
    <form id="formslider" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <div class="item form-group">
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="kd_slider" name="kd_slider" value="<?php echo $myData['kd_slider'] ?>" readonly="readonly" class="form-control col-md-7 col-xs-12">
      </div>
    </div>
    <div class="item form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="col-lg-8">
          <div class="fileupload fileupload-new" data-provides="fileupload">
            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?php echo"../assets/user/images/slider/$myData[foto]"; ?>" alt="" /></div>
            <div class="fileupload-preview fileupload-exists thumbnail"  style="max-width: 200px; max-height: 150px; line-height: 20px;"><img src="<?php echo"../assets/user/images/slider/$myData[foto]"; ?>" alt="" /></div>
            <div>
