  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Master Data <small>Penjualan</small></h2>
...
FROM
customer
INNER JOIN pemesanan ON pemesanan.kd_customer = customer.kd_customer where pemesanan.status_pemesanan='Lunas'
";
...
<tr class="<?php echo $warna; ?>">
  ...
  <td><CENTER> 
    <a href="penjualan.lihat?id=<?php echo $datapemesanan['id_pemesanan'];?>"><button class="btn btn-success btn-xs" > <i class="fa fa-search"></i></button></a>
