  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>
          Kode Penjualan : <?php echo $myData['id_pemesanan']; ?>
          <small>
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <p class="text-muted font-13 m-b-30">
              Berikut ini merupakan detail data penjualan dengan kode pemesanan <?php echo $myData['id_pemesanan']; ?>
            </p>
            <div class="top_grid2">     
...
<center>
                <strong>Detail Penjualan Kode Pemesanan <?php echo $myData['id_pemesanan']; ?></strong>
              </BR>1. Data Pemesanan Sudah Tersimpan di Data Penjualan .</br>
        </center>     
          </br>
