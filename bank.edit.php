    ...
    $kd_bank=$_GET['id'];
$mySql = "SELECT * FROM bank WHERE kd_bank='$kd_bank'";
...
$myData= mysql_fetch_array($myQry);
      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Edit Data <small>bank</small></h2>
    ...
    # baca variabel 
      ...
      if (empty($nama_foto)){
        $queryjeng = mysql_query("UPDATE bank SET nama_bank='$nama_bank', no_rekening='$no_rekening', pemilik='$pemilik' WHERE kd_bank='$kd_bank' ") or die(mysql_error());
      ...
      if (count($pesanError)>=1) {
        ...
        <div class='alert alert-danger alert-dismissable'>
         ...
         if(($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/pjpeg")){
             ...
             $query = mysql_query("UPDATE bank SET nama_bank='$nama_bank', no_rekening='$no_rekening', pemilik='$pemilik', foto='$jeneng' WHERE kd_bank='$kd_bank'") or die(mysql_error());
                

             }
             if ($query){
              unlink("../assets/images/bank/$myData[foto]");
             header('location: ./bank');
              }
    ...
    <form id="formbank" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <div class="item form-group">
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="kd_bank" name="kd_bank" value="<?php echo $myData['kd_bank'] ?>" readonly="readonly" class="form-control col-md-7 col-xs-12">
      </div>
    </div>
    ...
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="nama_bak" value="<?php echo $myData['nama_bank'] ?>" name="nama_bank" required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="pemilik" value="<?php echo $myData['pemilik'] ?>" name="pemilik" required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
      <input type="text" id="no_rekening" value="<?php echo $myData['no_rekening'] ?>" name="no_rekening" required="required" class="form-control col-md-7 col-xs-12">
    </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-lg-8">
          <div class="fileupload fileupload-new" data-provides="fileupload">
            <?php if (!empty($myData['foto'])) { ?>
              <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="../assets/images/bank/<?php echo $myData['foto']; ?>" alt=""></div>
