...
#                                               Name File     : terms of service.php                                #
#                                               Release Date  :                                                     #
...
<title>Data terms of service</title>

<?php 
$kd_halaman  = $_POST['kd_halaman'];
$content= $_POST['content'];
  $mySql = "SELECT * FROM halaman WHERE kd_halaman='TERMSOFSERVICE' ";
    ...
    <div class="page-title">
      <div class="title_left">
        <h3>
          ...
          <small>
            Manage Your Data terms of service
          </small>
        </h3>
      </div>
    </div>
...
if (isset($_POST['buttonsubmit'])) {
  ...
  $pesanError= array();
  if (trim($kd_halaman)=="") {
    $pesanError[]="Kode Data <b>terms of service</b> Masih kosong !!";
  }
  if (trim($content)=="") {
    $pesanError[]="Data Content<b>terms of service</b> Masih kosong !!";
  }
  ...
  #JIKA ADA PESAN ERROR DARI VALIDASI FORM 
   if (count($pesanError)>=1) {
    ...
    if ($edit){
      ...
      header('location: ./terms_of_service');
    }
  }
}
?>
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form id="formterms_of_services" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <input type="hidden" name="kd_halaman" value="TERMSOFSERVICE">
...
<script type="text/javascript">
 ...
 var formterms_of_services = $("#formterms_of_services").serialize();
 var validator = $("#formterms_of_services").bootstrapValidator({
  framework: 'bootstrap',
  feedbackIcons: {
  ...
  fields : {
    content : {
     validators: {
      notEmpty: {
       message: 'Content terms of service Harus  Diisi'
     }
   }
 }, 
