      ...
      <div class="">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>Tambah Data <small>artwork</small></h2>
      ...
      if (count($pesanError)>=1) {
        ...
        <div class='alert alert-danger alert-dismissable'>
         ...
         if(($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/pjpeg")){
             ...
             $kodeBaru= buatKode("artwork", "AW");
             $query = mysql_query("INSERT INTO artwork SET kd_artwork='$kodeBaru', title='$title', deskribsi='$deskribsi', foto='$jeneng' ") or die(mysql_error());
    ...
    <form id="formartwork" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <div class="item form-group">
       ...
       <div class="col-md-6 col-sm-6 col-xs-12">
        <input type="text" id="kd_artwork" name="kd_artwork" value="<?php echo $dataKode; ?>" readonly="readonly" class="form-control col-md-7 col-xs-12">
      </div>
    </div>
    <div class="item form-group">
