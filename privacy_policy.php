...
$content= $_POST['content'];
  $mySql = "SELECT * FROM halaman WHERE kd_halaman='PRIVACYPOLICY' ";
    ...
    <div class="page-title">
      <div class="title_left">
        <h3>
           Data Privacy Policy
          <small>
            Manage Your Data Privacy Policy
          </small>
        </h3>
      </div>
    </div>
...
if (isset($_POST['buttonsubmit'])) {
  ...
  $pesanError= array();
  if (trim($kd_halaman)=="") {
    $pesanError[]="Kode Data <b>Privacy Policy</b> Masih kosong !!";
  }
  if (trim($content)=="") {
    $pesanError[]="Data Content<b>Privacy Policy</b> Masih kosong !!";
  }
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form id="formprivacypolicy" method="POST" class="form-horizontal form-label-left" enctype="multipart/form-data">
      <input type="hidden" name="kd_halaman" value="PRIVACYPOLICY">
...
<script type="text/javascript">
 ...
 var formprivacypolicy = $("#formprivacypolicy").serialize();
 var validator = $("#formprivacypolicy").bootstrapValidator({
  framework: 'bootstrap',
  feedbackIcons: {
